...
def register_graph_tools(mcp: FastMCP) -> None:
    ...
    def create_notion(ctx: Context[ServerSession, AppContext], caption: str, description: str | None = None, relationships: dict[str, list[str]] | None = None) -> dict[str, Any]:
        """
            ...
            The optional `description` parameter stores a free-text description of the notion.
    ...
    def change_notion_description(
        ...
        """Set or update the description of a notion identified by caption."""
        try:
            g = get_g(ctx)
            return gremlin_helpers.change_notion_description(g, caption, description)
        except Exception:
            raise ToolError(traceback.format_exc())
